    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 font-['Poppins',sans-serif]">
      ...
      <section className="py-32 px-4 bg-gradient-to-br from-slate-900 to-blue-900 relative">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-12">
            <span className="bg-gradient-to-r from-cyan-400 to-emerald-400 bg-clip-text text-transparent">Conclusão</span>
          </h2>
          ...
          <div className="flex justify-center mt-16">
            <div className="relative group">
              <img 
                ...
                className="w-80 h-auto mx-auto rounded-2xl shadow-2xl group-hover:scale-105 transition-transform duration-300"
              />
